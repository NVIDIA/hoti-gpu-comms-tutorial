...
NCCL4Py host API exercise: grouped Send/Recv reference.

Usage:
mpirun -np 2 python send_recv_SOLVED.py
"""
...
def main():
    ...
    with nccl.group():
        nccl_comm.send(send_data, peer=peer)
        nccl_comm.recv(recv_data, peer=peer)
