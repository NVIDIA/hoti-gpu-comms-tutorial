...
# See the Apache-2.0 terms at https://github.com/NVIDIA/nccl/blob/master/LICENSE.txt.
...
def main():  # noqa: C901 — kept as a single function to mirror ep_test.cu
    ...
    # TODO: Create the NCCL EP group from the communicator and group config.
    ep_group = None
    ...
    # TODO: Create the NCCL EP handle for this layout and routing tensor.
    ep_handle = None
    stream.sync()
    ...
    # TODO: Dispatch the input tokens to their selected experts.

    if is_ll and dispatch_send_only:
    ...
    # TODO: Combine expert outputs back into source-token order.

    if is_ll and combine_send_only:
